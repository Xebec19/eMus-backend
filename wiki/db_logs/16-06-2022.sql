...
SELECT U.USER_ID, U.USER_NAME, COALESCE(U.FIRST_NAME,' ',U.LAST_NAME) AS FULL_NAME, U.EMAIL, P.PLAN_ID, 
P.PLAN_NAME, P.NO_OF_STORES, P.NO_OF_MEMBERS FROM USERS U LEFT JOIN PLANS P ON P.PLAN_ID = U.PLAN_ID
WHERE STATUS = 'active';